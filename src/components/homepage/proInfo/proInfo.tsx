      ...
      <div className="pro-info-container">
        ...
        <div className="pro-info-content">
          ...
          <p className="pro-info-description">
            Les professionnels authentifiés bénéficient de{" "}
            <strong>prix professionnels</strong> exclusifs sur tous nos
            produits.
          </p>
          {!isAuthenticated ? (
            <div className="pro-info-actions">
              <Link to="/shop" className="pro-info-link">
                Créer un compte professionnel en se connectant puis cliquez sur le bouton "Devenir pro"
            ...
            <div className="pro-info-status pro-info-status--pending">
              ...
              <span>
                Votre demande est en cours de vérification (délai de 48h)
              </span>
            </div>
          ) : (
        ...
        <div className="pro-info-details">
          <div className="pro-info-detail-item">
            ...
            <div>
              ...
              <p>
                Votre compte professionnel est validé sous 48h après
                renseignement de vos informations.
              </p>
            </div>
          </div>
          <div className="pro-info-detail-item">
            ...
            <div>
              ...
              <p>
                Accédez à des tarifs préférentiels réservés aux professionnels
                de l'automobile.
              </p>
            </div>
          </div>
